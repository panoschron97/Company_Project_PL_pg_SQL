--postgres
CREATE DATABASE Company_Project_PL_pgSQL;
--Company_Project_PL_pgSQL 
--Admin User
...
COMMIT;
--
GRANT CONNECT ON DATABASE Company_Project_PL_pgSQL TO Panos_Chron;
COMMIT;
--
GRANT USAGE ON SCHEMA Public TO Panos_Chron;
COMMIT;
--
GRANT CONNECT ON DATABASE Company_Project_PL_pgSQL TO Panos_Chron1;
COMMIT;
--
...
CONSTRAINT CompanyNameJSON_CHK CHECK (CompanyNameJSON IS NOT NULL)
);
COMMIT;
--
...
COMMIT;
--
REVOKE CONNECT ON DATABASE Company_Project_PL_pgSQL FROM Panos_Chron1;
COMMIT;
--
REVOKE USAGE ON SCHEMA Public FROM Panos_Chron;
COMMIT;
--
REVOKE CONNECT ON DATABASE Company_Project_PL_pgSQL FROM Panos_Chron;
COMMIT;
--
...
COMMIT;
--postgres
DROP DATABASE IF EXISTS Company_Project_PL_pgSQL;